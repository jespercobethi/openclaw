...
queries = [
    "wind turbine pitch motor control strategy optimization",
    "permanent magnet synchronous motor wind pitch servo",
    "multi-motor synchronous control wind energy",
    "model predictive control wind turbine pitch",
    "wind turbine pitch system motor coordination"
]
...
for p in unique:
    ...
    # Check if related to wind turbine pitch, motor control, PMSM, MPC, multi-motor
    keywords = ['pitch', 'wind turbine', 'wind energy', 'permanent magnet', 'pmsm', 'synchronous motor', 'servo', 'multi-motor', 'predictive control', 'synchronization', 'torque control']
